// Dictionary of valid 5-letter words for input validation
const dictionary = [
  "about", "above", "abuse", "actor", "acute", "admit", "adopt", "adult", "after", "again",
  "agent", "agree", "ahead", "alarm", "album", "alert", "alien", "align", "alike", "alive",
  "allow", "alone", "along", "alter", "among", "anger", "angle", "angry", "apart", "apple",
  "apply", "arena", "argue", "arise", "array", "arrow", "aside", "asset", "atlas", "avoid",
  "awake", "award", "aware", "badly", "baker", "balls", "band", "banks", "barely", "batch",
  ...
  "shown", "sides", "sight", "simon", "since", "sixth", "sixty", "sized", "skill", "sleep",
  "slide", "small", "smart", "smile", "smith", "smoke", "snake", "snow", "socks", "solid",
  ...
  "three", "threw", "throw", "thumb", "tiger", "tight", "timer", "tiny", "title", "today",
  ...
  "would", "write", "wrong", "wrote", "young", "youth", "slate", "crane", "adieu", "audio",
  "ounce", "raise", "learn", "stern", "flash", "grind", "mount", "perky", "rebel", "fudge",
  "cinch", "gauge", "dodge", "cogent", "haste"
];

// Convert to Set for O(1) lookup performance
const dictionarySet = new Set(dictionary.map(word => word.toUpperCase()));